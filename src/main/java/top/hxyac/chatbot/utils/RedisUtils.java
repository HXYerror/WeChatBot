...
public class RedisUtils{
    ...
    @Value("${hxyac.wechat.prefix}")
    public  String prefix;

    public final static String tokenKey = "JWT_token";

    public final static String likeKey = "like";

    public final static String dislikeKey = "dislike";
